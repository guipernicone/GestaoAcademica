...
public class InformaTurmaGUI extends JFrame{
        ...
        public void actionPerformed(ActionEvent event){
           if(event.getSource() ==  buttonInsCri1){
            ...
            if(event.getSource() ==  buttonInsCri2){
                ...
                EscolheArquivoGUI frame2 = new EscolheArquivoGUI( Integer.parseInt(numTurma));
                frame2.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
                frame2.setSize(400,300);
                frame2.setVisible(true);
            }
            InformaTurmaGUI.this.dispose();
        }
    }
}